// iPhone / Mac sing-box 1.14.0-alpha.44：WireGuard endpoint 回家
// 2026-07-15 RealIP DNS-v2 alpha44 长期版
...
console.log('🚀 开始生成 WireGuard 回家配置（2026-07-15 RealIP DNS-v2 alpha44 长期版）')
...
config.route.rules = [
  ...
  ...baseRules,
  ...config.route.rules.filter(r => !isUnconditionalIpv6Reject(r))
]
...
console.log('✅ 完成 WireGuard 回家配置（2026-07-15 RealIP DNS-v2 alpha44 长期版）')
