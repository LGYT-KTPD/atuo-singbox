// iPhone / Mac sing-box 1.14.0-alpha.36：WireGuard endpoint 回家
...
console.log('🚀 开始生成 WireGuard 回家配置（2026-06-29 RealIP DNS-v2 alpha36 长期版）')
...
console.log('✅ 完成 WireGuard 回家配置（2026-06-29 RealIP DNS-v2 alpha36 长期版）')
