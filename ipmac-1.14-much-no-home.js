// iPhone / Mac sing-box 1.14-alpha.21：机场多分组多节点 no-home（增强稳定版）

console.log('🚀 开始生成多分组 no-home 配置')
...
if (!proxyGroup.outbounds.includes('direct')) {
  proxyGroup.outbounds.push('direct')
}
...
console.log('✅ 完成多分组 no-home 配置生成（alpha.21 增强稳定版）')
