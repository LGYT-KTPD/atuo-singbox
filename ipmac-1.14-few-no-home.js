// iPhone / Mac sing-box 1.14.0-alpha.44：自建少节点 no-home
...
console.log('🚀 开始生成 no-home 配置（2026-07-15 RealIP DNS-v2 alpha44 长期版）')
...
console.log('✅ 完成 no-home 配置生成（2026-07-15 RealIP DNS-v2 alpha44 长期版）')
